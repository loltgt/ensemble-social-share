...
/*!
   ...
   * @license MIT License
   */Object.defineProperty(t,"__esModule",{value:!0}),t.SocialShare=void 0;const e=/html|head|body|meta|link|style|script/i,s=/(<(html|head|body|meta|link|style|script)*>)/i,n=/attributes|classList|innerHTML|outerHTML|nodeName|nodeType/;class i{constructor(t,s,o,r){if(!new.target)throw"ensemble error: Wrong invocation, must be called with new.";const a=this._ns="_"+t,l=o?s.toString():"div";if(e.test(l))throw new Error(`ensemble.Compo error: The tag name provided ('${l}') is not a valid name.`);const h=this[a]=document.createElement(l);if(this[a].__compo=this,r&&"object"==typeof r)for(const e in r){const s=e.toString();if(n.test(s))throw new Error(`ensemble.Compo error: The property name provided ('${s}')' is not a valid name.`);if(0===s.indexOf("on")&&r[s])h[s]=r[s].bind(this);else if("object"!=typeof r[s])h[s]=r[s];else if("children"===s&&"object"==typeof r[s]&&r[s].length)for(const e of r.children){const s=e.tag,n=e.name,o=e.props;this.append(new i(t,s,n,o))}}if(0!=o&&1!=o){const e=h.className;h.className=t+"-"+s,o&&(h.className+=" "+t+"-"+o),e&&(h.className+=" "+e)}}install(t,e){return"function"==typeof e&&e.call(this,this[this._ns]),!!t.appendChild(this[this._ns])}uninstall(t,e){return"function"==typeof e&&e.call(this,this[this._ns]),!!t.removeChild(this[this._ns])}up(t,e){return"function"==typeof e&&e.call(this,this[this._ns]),!!t.replaceWith(this[this._ns])}append(t){const e=this._ns;return!!this[e].appendChild(t[e])}prepend(t){const e=this._ns;return!!this[e].prependChild(t[e])}remove(t){const e=this._ns;return!!this[e].removeChild(t[e])}replace(t){}clone(t=!1){}inject(t){if(t instanceof Element==!1||e.test(t.tagName)||s.test(t.innerHTML))throw new Error("ensemble.Compo error: The remote object could not be resolved into a valid node.");this.empty(),this[this._ns].appendChild(t)}empty(){for(;this.first;)this.remove(this.first)}hasAttr(t){return this[this._ns].hasAttribute(t)}getAttr(t){return this[this._ns].getAttribute(t)}setAttr(t,e){this[this._ns].setAttribute(t,e)}delAttr(t){this[this._ns].removeAttribute(t)}getStyle(t){return window.getComputedStyle(this[this._ns])[t]}show(){this[this._ns].hidden=!1}hide(){this[this._ns].hidden=!0}enable(){this[this._ns].disabled=!1}disable(){this[this._ns].disabled=!0}get node(){return console.warn("ensemble.Compo","Direct access to the Element node is strongly discouraged."),this[this._ns]}get parent(){const t=this._ns;return this[t].parentElement&&"__compo"in this[t].parentElement?this[t].parentElement.__compo:null}get children(){return Array.prototype.map.call(this[this._ns].children,(t=>t.__compo))}get first(){const t=this._ns;return this[t].firstElementChild?this[t].firstElementChild.__compo:null}get last(){const t=this._ns;return this[t].lastElementChild?this[t].lastElementChild.__compo:null}get previous(){const t=this._ns;return this[t].previousElementSibling?this[t].previousElementSibling.__compo:null}get next(){const t=this._ns;return this[t].nextElementSibling?this[t].nextElementSibling.__compo:null}get classList(){return this[this._ns].classList}static isCompo(t){return Symbol.for(t)===Symbol.for(i.prototype)}get[Symbol.toStringTag](){return"ensemble.Compo"}}
/*!
   ...
   * @copyright Copyright (C) Leonardo Laureti
   * @license MIT License
   */class o{constructor(t,e){if(!new.target)throw"ensemble error: Wrong invocation, must be called with new.";e&&"object"==typeof e&&Object.assign(this,{},e);this[this._ns="_"+t]={ns:t}}compo(t,e,s,n=!1,o=!1,r=!1){const a=this[this._ns].ns;let l;return l=n?{ns:a,tag:t,name:e,props:s,fresh:o,stale:r}:new i(a,t,e,s),o&&"function"==typeof o&&(l.fresh=s.onfresh=o),r&&"function"==typeof r&&(l.stale=s.onstale=r),l}async render(t){const e=this._ns;this[e][t]&&this[e][t].rendered||(this[e][t]={rendered:!0,fresh:this[t].fresh,stale:this[t].stale,params:this[t]},this[t]=new i(this[t].ns,this[t].tag,this[t].name,this[t].props)),this[e][t].fresh()}async stale(t){const e=this._ns;this[e][t]&&this[e][t].rendered&&this[e][t].stale()}async reflow(t,e){const s=this._ns;e?this[s][t]=this.compo(this[s][t].params.ns,this[s][t].params.name,this[s][t].params.props):this[s][t]&&this[s][t].rendered&&this[s][t].fresh()}static isData(t){return Symbol.for(t)===Symbol.for(o.prototype)}get[Symbol.toStringTag](){return"ensemble.Data"}}
/*!
   ...
   * @copyright Copyright (C) Leonardo Laureti
   * @license MIT License
   */class r{constructor(t,e,s){if(!new.target)throw"ensemble error: Wrong invocation, must be called with new.";const n=this._ns="_"+t;s=(i.isCompo(s)?s.node:s)||document,this[n]={name:e,node:s}}add(t,e=!1){this[this._ns].node.addEventListener(this[this._ns].name,t,e)}remove(t){this[this._ns].node.removeEventListener(this[this._ns].name,t)}static isEvent(t){return Symbol.for(t)===Symbol.for(r.prototype)}get[Symbol.toStringTag](){return"ensemble.Event"}}
/*!
